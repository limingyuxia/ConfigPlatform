...
var UserWhere = struct {
	...
	Gender:     whereHelpernull_Int{field: "`user`.`gender`"},
	Region:     whereHelpernull_String{field: "`user`.`region`"},
	Phone:      whereHelpernull_String{field: "`user`.`phone`"},
	Email:      whereHelpernull_String{field: "`user`.`email`"},
	Photo:      whereHelpernull_String{field: "`user`.`photo`"},
...
var (
	userAllColumns            = []string{"id", "username", "password", "nickname", "gender", "region", "phone", "email", "photo", "create_time", "update_time"}
	userColumnsWithoutDefault = []string{"username", "password", "nickname", "gender", "region", "phone", "email", "photo"}
	userColumnsWithDefault    = []string{"id", "create_time", "update_time"}
