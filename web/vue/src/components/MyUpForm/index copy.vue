  ...
  <div>
      ...
      <el-row :gutter="20" :key="index"   v-for="item,index in ConfHeader">
          ...
          <el-col :key="colindex" :span="colitem.span || 60" v-for="colitem,colindex in item" >
            ...
            <el-form-item  :label="colitem.label" v-if="colitem.type == 'tag'" :prop="colitem.model">
              ...
              <el-form-item :label="colitem.label" v-if="colitem.type == 'input'" :prop="colitem.model">
                <el-input
      ...
      default:()=> [
        [
          {"label":"项目id","type":"input","span":50,"placeholder":"描述","disabled":true,"model":"id"},
           {"label":"项目id","type":"input","span":5,"placeholder":"描述","disabled":false,"model":"id1"},
